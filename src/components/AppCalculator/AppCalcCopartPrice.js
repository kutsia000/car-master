...
const AppCalcCopartPrice = () => {
  ...
  const calculateFees = (finalBidPrice) => {
    ...
    else if (finalBidPrice >= 50 && finalBidPrice <= 99.99) securedPaymentFee = 1;
    ...
    else if (finalBidPrice >= 8500 && finalBidPrice <= 8999.99) securedPaymentFee = 820;
    else if (finalBidPrice >= 9000 && finalBidPrice <= 9999.99) securedPaymentFee = 820;
    else if (finalBidPrice >= 10000 && finalBidPrice <= 14999.99) securedPaymentFee = 850;
    else if (finalBidPrice >= 15000) securedPaymentFee = finalBidPrice * 0.06;

    // Live Bid Fee logic
    if (finalBidPrice > 0 && finalBidPrice <= 100) liveBidFee = 0;
...
export default AppCalcCopartPrice;
